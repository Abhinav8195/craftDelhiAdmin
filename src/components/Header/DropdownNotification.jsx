...
const notifications = [
  { id: 1, title: 'New Message Received', message: 'You have a new message from John Doe.', icon: <FaBell className="text-blue-500" />, date: '11 Apr, 2025' },
  { id: 2, title: 'Order Confirmed', message: 'Your order #1234 has been successfully confirmed.', icon: <FaCheckCircle className="text-green-500" />, date: '10 Apr, 2025' },
  { id: 3, title: 'Server Downtime Alert', message: 'Scheduled maintenance on 14th Apr from 2AM to 5AM.', icon: <FaExclamationTriangle className="text-yellow-500" />, date: '09 Apr, 2025' },
  { id: 4, title: 'New Feature Released', message: 'Explore the new dark mode and advanced filters now!', icon: <FaInfoCircle className="text-indigo-500" />, date: '08 Apr, 2025' },
];
