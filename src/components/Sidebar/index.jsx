...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-50 flex overflow-x-hidden bg-[#ffffff] border border-[#D9D9D9] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}
      style={{
        width: '280px',
        height: '100vh', 
        padding: '16px',
  ...
  {({ isActive }) => (
    <div className="grow shrink basis-0 h-5 justify-start items-center gap-3 flex">
      <div className="w-5 h-5 relative overflow-hidden">
        <img
          src={isActive?IconPresentationChart_01:i1active}
          alt="Logo"
      ...
      >
        Dashboard
            ...
            <NavLink to="/buyer-management"className={({ isActive }) => {
    const bgColor = isActive ? "bg-[#024a63]" : "";
    return `self-stretch px-3 py-4 rounded-lg justify-start items-center gap-2 inline-flex ${bgColor}`;
  }}>
     {({ isActive }) => (
              <div className="grow shrink basis-0 h-5 justify-start items-center gap-3 flex">
                <div className="w-5 h-5 relative overflow-hidden">
                  <img src={isActive? buyeractive:IconUsersEdit} alt="Buyer Management Icon" className="w-full h-full object-cover" />
                </div>
                <div className={`grow shrink basis-0 text-xs font-medium font-['Montserrat'] leading-none ${isActive ? "text-[#ffffff]" : "text-[black]"}`}>Buyer Management</div>
              </div>
              )}
            </NavLink>

            <NavLink to="/seller-management" className={({ isActive }) => {
    const bgColor = isActive ? "bg-[#024a63]" : "";
    return `self-stretch px-3 py-4 rounded-lg justify-start items-center gap-2 inline-flex ${bgColor}`;
  }}>
     {({ isActive }) => (
              <div className="grow shrink basis-0 h-5 justify-start items-center gap-3 flex">
                <div className="w-5 h-5 relative overflow-hidden">
                  <img src={isActive?selleractive:IconUserCheck_02} alt="Seller Management Icon" className="w-full h-full object-cover" />
                </div>
                <div className={`grow shrink basis-0 text-xs font-medium font-['Montserrat'] leading-none ${isActive ? "text-[#ffffff]" : "text-[black]"}`}>Seller Management</div>
              </div>
            )}
            </NavLink>
            <NavLink to="/product-management" className={({ isActive }) => {
    const bgColor = isActive ? "bg-[#024a63]" : "";
    return `self-stretch px-3 py-4 rounded-lg justify-start items-center gap-2 inline-flex ${bgColor}`;
  }}>
     {({ isActive }) => (
              <div className="grow shrink basis-0 h-5 justify-start items-center gap-3 flex">
                <div className="w-5 h-5 relative overflow-hidden">
                  <img src={isActive? packactive:IconPackage} alt="Product Management Icon" className="w-full h-full object-cover" />
                </div>
                <div className={`grow shrink basis-0 text-xs font-medium font-['Montserrat'] leading-none ${isActive ? "text-[#ffffff]" : "text-[black]"}`}>Product Management</div>
              </div>
            )}
            </NavLink>
            <NavLink to="/order-management" className={({ isActive }) => {
    const bgColor = isActive ? "bg-[#024a63]" : "";
    return `self-stretch px-3 py-4 rounded-lg justify-start items-center gap-2 inline-flex ${bgColor}`;
  }}>
     {({ isActive }) => (
              <div className="grow shrink basis-0 h-5 justify-start items-center gap-3 flex">
                ...
                <div className={`grow shrink basis-0 text-xs font-medium font-['Montserrat'] leading-none ${isActive ? "text-[#ffffff]" : "text-[black]"}`}>Order Management</div>
              </div>
            )}
            </NavLink>
            <NavLink to="/payment-management" className={({ isActive }) => {
    const bgColor = isActive ? "bg-[#024a63]" : "";
    return `self-stretch px-3 py-4 rounded-lg justify-start items-center gap-2 inline-flex ${bgColor}`;
  }}>
     {({ isActive }) => (
              <div className="grow shrink basis-0 h-5 justify-start items-center gap-3 flex">
                <div className="w-5 h-5 relative overflow-hidden">
                  <img src={isActive?payactive:IconCoinsHand} alt="Payment Management Icon" className="w-full h-full object-cover" />
                </div>
                <div className={`grow shrink basis-0 text-xs font-medium font-['Montserrat'] leading-none ${isActive ? "text-[#ffffff]" : "text-[black]"}`}>Payment Management</div>
              </div>
            )}
            </NavLink>
