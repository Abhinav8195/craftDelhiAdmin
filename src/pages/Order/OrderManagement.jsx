        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="h-[200px] p-5 bg-gradient-to-b from-[#ffe2e6] to-white rounded-xl border border-[#d9d9d9] flex flex-col  justify-center gap-[15px] items-center text-center">
              <div className="text-black text-base font-bold text-center">Total Orders</div>
            ...
            <div className="h-[200px] p-5 bg-gradient-to-b from-[#fff4de] to-white rounded-xl border border-[#d9d9d9] flex flex-col items-center justify-center gap-[15px] text-center">
              <div className="text-black text-base font-bold text-center">Pending Orders</div>
              <div className="text-black text-2xl font-bold">211</div>
            </div>
            <div className="h-[200px] p-5 bg-gradient-to-b  from-green-100 to-white rounded-xl border border-[#d9d9d9] flex flex-col items-center justify-center gap-[15px] text-center">
              <div className="text-black text-base font-bold text-center">Completed Orders</div>
              <div className="text-black text-2xl font-bold">300</div>
            </div>
          </div>
